...
/// <summary>
/// Дверь, ведущая с улицы в дом Аиды.
/// </summary>
public class AidaDoor : MonoBehaviour
{
	[Tooltip ("Название сцены, представляющей дом Аиды.")]
	...
	{
		// Внутри дома Аида будет стоять у выхода.
		GlobalManager.instance.playerStartPointName = "Start Point (2)";

		StartCoroutine (LoadNextScene (aidaHouseSceneName));
	}
